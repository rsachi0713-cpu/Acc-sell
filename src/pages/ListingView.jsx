    ...
    const fetchListing = async () => {
      ...
      try {
        const { data, error: fetchError } = await supabase
          .from('listings')
          .select('*, profiles:seller_id(username, full_name, avatar_url, is_online, rating, reviews, created_at, whatsapp)')
          .eq('id', id)
          .single();
          ...
          <div className="glass-panel p-6">
            ...
            {item.seller.whatsapp ? (
              ...
              >
                ...
                Message Seller
                <span className="text-[10px] opacity-80 border-l border-white/20 pl-2">+{item.seller.whatsapp}</span>
              </a>
            ) : (
              <button 
